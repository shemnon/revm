...
## [8.0.0](https://github.com/shemnon/revm/compare/revm-primitives-v7.1.0...revm-primitives-v8.0.0) - 2024-08-02
...
### Fixed
- *(EOF)* Overflow on num_sections ([#1656](https://github.com/shemnon/revm/pull/1656))

### Other
- Renamed some city name ([#1645](https://github.com/shemnon/revm/pull/1645))
...
- *(eof)* simplify magic checks ([#1633](https://github.com/shemnon/revm/pull/1633))
