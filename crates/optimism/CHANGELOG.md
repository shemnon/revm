...
## [1.0.0](https://github.com/shemnon/revm/releases/tag/revm-optimism-v1.0.0) - 2024-10-19

### Added

- restructuring Part6 transaction crate ([#1814](https://github.com/shemnon/revm/pull/1814))
- Restructuring Part3 inspector crate ([#1788](https://github.com/shemnon/revm/pull/1788))
...
- introducing EvmWiring, a chain-specific configuration ([#1672](https://github.com/shemnon/revm/pull/1672))
...
- make macro crate-agnostic ([#1802](https://github.com/shemnon/revm/pull/1802))
...
- Test for l1 gas used and l1 fee for ecotone tx ([#1748](https://github.com/shemnon/revm/pull/1748))
- *(deps)* bump anyhow from 1.0.88 to 1.0.89 ([#1772](https://github.com/shemnon/revm/pull/1772))
