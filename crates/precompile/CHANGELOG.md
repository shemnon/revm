...
## [9.3.0](https://github.com/shemnon/revm/compare/revm-precompile-v9.2.0...revm-precompile-v9.3.0) - 2024-08-02

### Added
- use batch bn256 pair operation ([#1643](https://github.com/shemnon/revm/pull/1643))

### Other
- *(deps)* bump blst from 0.3.12 to 0.3.13 ([#1669](https://github.com/shemnon/revm/pull/1669))
