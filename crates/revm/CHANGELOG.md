...
## [12.2.0](https://github.com/shemnon/revm/compare/revm-v12.1.0...revm-v12.2.0) - 2024-08-02

### Added
- *(EOF)* EOF Validation add code type and sub container tracker ([#1648](https://github.com/shemnon/revm/pull/1648))

### Other
- *(deps)* bump tokio from 1.38.1 to 1.39.2 ([#1668](https://github.com/shemnon/revm/pull/1668))
