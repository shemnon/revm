...
## [14.0.2](https://github.com/shemnon/revm/compare/revm-v14.0.1...revm-v14.0.2) - 2024-09-09

### Other

- Add test for `revm::optimism::L1BlockInfo::calculate_tx_l1_cost_fjord` ([#1743](https://github.com/shemnon/revm/pull/1743))
- *(deps)* bump tokio from 1.39.2 to 1.40.0 ([#1739](https://github.com/shemnon/revm/pull/1739))
